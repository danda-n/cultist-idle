...
> Version 0.3 | April 2026 | Status: Systems Locked (Layer 1)
...
- **Expedition loss** — cultists sent on low-devotion expeditions risk not returning. Partially Anima-refunded.
...
| **Lost** | Low devotion run | Cultists don't return. Partial Anima refund. |
...
| 12 | **The First Artifact** | Cindermark or Voidwreath complete; ritual circle stirs | ~10:30 |
...
- Devotion decayed — clear visual, one obvious fix waiting
