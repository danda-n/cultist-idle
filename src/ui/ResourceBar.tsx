  ...
  return (
    <div className="panel">
      ...
      <div style={{ display: 'flex', alignItems: 'baseline', gap: '8px' }}>
        <span className="text-number" style={{ fontSize: '1.5rem', color: 'var(--gold-primary)' }}>
          {formatNumber(resources.anima)}
        </span>
        {ratePerMin > 0 && (
          <span className="text-number text-green" style={{ fontSize: '0.8rem' }}>
      ...
      <div className="resource-bar-track">
        ...
        <div
          ...
          title={`Soft cap: ${SOFT_CAP_ANIMA}`}
          style={{ left: `${softCapPct}%` }}
        />
      </div>
      {resources.anima >= SOFT_CAP_ANIMA && (
        <div style={{ fontSize: '0.75rem', marginTop: '4px' }} className="text-warn">
