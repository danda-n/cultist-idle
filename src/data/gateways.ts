// Build costs
export const GATEWAY_BUILD_COST_ANIMA = 250

// Gateway capacity upgrade costs
export const GATEWAY_CAPACITY_T2_COST_ANIMA = 150
export const GATEWAY_CAPACITY_T2_COST_GNOSIS = 80
export const GATEWAY_CAPACITY_T3_COST_ANIMA = 300
